...
import 'package:real_estate_mobileapp/views/details/apartment_details.dart';
    ...
    return Column(
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: List.generate(listApartment.length, (index) {
              return HouseCard(house: listApartment[index],);
            }),
          ),
        ),
        Padding(
        ...
        SingleChildScrollView(
          ...
          child: Column(
            children: List.generate(listApartment.length, (index) {
              return BestHouse(house: listApartment[index],);
            }),
          ),
        ),
      ],
    ...
    return GestureDetector(
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (BuildContext context) => ApartmentDetails(house: house)));
        },
        child: Padding(
