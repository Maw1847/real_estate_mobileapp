...
import 'package:real_estate_mobileapp/views/details/other_details.dart';
    ...
    return Column(
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: List.generate(listOther.length, (index) {
              return HouseCard(house: listOther[index],);
            }),
          ),
        ),
        Padding(
        ...
        SingleChildScrollView(
          ...
          child: Column(
            children: List.generate(listOther.length, (index) {
              return BestHouse(house: listOther[index],);
            }),
          ),
        ),
      ],
    ...
    return GestureDetector(
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (BuildContext context) => OtherDetails(house: house)));
        },
        child: Padding(
