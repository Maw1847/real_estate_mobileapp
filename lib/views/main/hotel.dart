...
import 'package:real_estate_mobileapp/views/details/hotel_details.dart';
    ...
    return Column(
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: List.generate(listHotel.length, (index) {
              return HouseCard(house: listHotel[index],);
            }),
          ),
        ),
        Padding(
        ...
        SingleChildScrollView(
          ...
          child: Column(
            children: List.generate(listHotel.length, (index) {
              return BestHouse(house: listHotel[index],);
            }),
          ),
        ),
      ],
    ...
    return GestureDetector(
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (BuildContext context) => HotelDetails(house: house)));
        },
        child: Padding(
